...
#
# This file is a modified version of the run_classifier.py script https://github.com/google-research/bert/blob/master/run_classifier.py
# In particular, it uses tf_metrics to compute metrics in the evaluation phase.
#
...
def evaluate(estimator, label_rate, eval_examples, task_name, label_list, tokenizer):
    ...
    overall_result_file = open(task_name + "_statistics_BERT" + str(label_rate) + ".txt", "a+")
...
def main(_):
  ...
  if FLAGS.do_train:
    train_examples = processor.get_labeled_examples(FLAGS.data_dir)
